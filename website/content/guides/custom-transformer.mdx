...
<Callout type="info">
  Writing a transformer is the most involved customisation in SayKit. Read [messages](/core-concepts/messages)
  and [architecture](/core-concepts/architecture) first.
</Callout>
