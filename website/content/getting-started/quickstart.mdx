...
Pick a locale and wrap your tree in `SayProvider`:
...
That's it. Your app now renders in the matched locale, and switching locales is just a different
view plus a re-render away.
