...
/**
 * Switching locale here is a *navigation*, not a runtime call on a shared
 * object: the locale lives in the URL, so the server re-renders with the right
 * view and the middleware persists the choice in a cookie.
 */
